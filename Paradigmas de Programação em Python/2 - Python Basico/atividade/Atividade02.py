"""Elabore um programa em Python para criar uma função simples em Python que recebe dois argumentos
 – um número e uma string – e imprime esses valores, destacando o conceito de binding."""
